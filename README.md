...
Let me introduce my awesome online-based ticket booking, KuyTick. This repository utilized Node.js for package and React.js as library for development.
...
- Web Styling : TailwindCSS, React Icons
...
```sh
  git clone https://github.com/SyarifKA/fgh21-react-event-organizer.git
  cd <project-name>
```
