...
function EventCard() {
    return (
            <div  className='flex gap-4 relative overflow-x-scroll'>
                <div className='w-[260px] h-[376px] relative rounded-3xl overflow-hidden relative'>
                ...
                <div className='w-[260px] h-[376px] relative rounded-3xl overflow-hidden relative'>
                        <img src={Event2} alt="Event-1" className='w-full h-full relative' />
                    <div className='flex flex-col justify-end text-white gap-6 px-[25px] py-[32px] absolute w-full h-full bg-gradient-to-b from-transparent via-[rgba(0,0,0,0)] to-[rgba(16,20,38,1)] top-0 left-0'>
                        <div className='flex flex-col'>
                            <div className='text-sm'>Wed, 15 Nov, 4:00 PM</div>
                            <div className='text-2xl font-semibold'>Sights & Sounds Exhibition</div>
                ...
                <div className='w-[260px] h-[376px] relative rounded-3xl overflow-hidden relative'>
                        <img src={Event3} alt="Event-1" className='w-full h-full relative' />
                    <div className='flex flex-col justify-end text-white gap-6 px-[25px] py-[32px] absolute w-full h-full bg-gradient-to-b from-transparent via-[rgba(0,0,0,0)] to-[rgba(16,20,38,1)] top-0 left-0'>
                        <div className='flex flex-col'>
                            <div className='text-sm'>Wed, 15 Nov, 4:00 PM</div>
                            <div className='text-2xl font-semibold'>Sights & Sounds Exhibition</div>
                ...
                <div className='w-[260px] h-[376px] relative rounded-3xl overflow-hidden relative'>
                        <img src={Event4} alt="Event-1" className='w-full h-full relative' />
                    <div className='flex flex-col justify-end text-white gap-6 px-[25px] py-[32px] absolute w-full h-full bg-gradient-to-b from-transparent via-[rgba(0,0,0,0)] to-[rgba(16,20,38,1)] top-0 left-0'>
                        <div className='flex flex-col'>
                            <div className='text-sm'>Wed, 15 Nov, 4:00 PM</div>
                            <div className='text-2xl font-semibold'>Sights & Sounds Exhibition</div>
                ...
                <div className='w-[260px] h-[376px] relative rounded-3xl overflow-hidden relative'>
                        <img src={Event5} alt="Event-1" className='w-full h-full relative' />
                    <div className='flex flex-col justify-end text-white gap-6 px-[25px] py-[32px] absolute w-full h-full bg-gradient-to-b from-transparent via-[rgba(0,0,0,0)] to-[rgba(16,20,38,1)] top-0 left-0'>
                        <div className='flex flex-col'>
                            <div className='text-sm'>Wed, 15 Nov, 4:00 PM</div>
                            <div className='text-2xl font-semibold'>Sights & Sounds Exhibition</div>
                ...
                <div className='w-[260px] h-[376px] relative rounded-3xl overflow-hidden relative'>
                        <img src={Event6} alt="Event-1" className='w-full h-full relative' />
                    <div className='flex flex-col justify-end text-white gap-6 px-[25px] py-[32px] absolute w-full h-full bg-gradient-to-b from-transparent via-[rgba(0,0,0,0)] to-[rgba(16,20,38,1)] top-0 left-0'>
                        <div className='flex flex-col'>
                            <div className='text-sm'>Wed, 15 Nov, 4:00 PM</div>
                            <div className='text-2xl font-semibold'>Sights & Sounds Exhibition</div>
                ...
                <div className='w-[260px] h-[376px] relative rounded-3xl overflow-hidden relative'>
                        <img src={Event7} alt="Event-1" className='w-full h-full relative' />
                    <div className='flex flex-col justify-end text-white gap-6 px-[25px] py-[32px] absolute w-full h-full bg-gradient-to-b from-transparent via-[rgba(0,0,0,0)] to-[rgba(16,20,38,1)] top-0 left-0'>
                        <div className='flex flex-col'>
                            <div className='text-sm'>Wed, 15 Nov, 4:00 PM</div>
                            <div className='text-2xl font-semibold'>Sights & Sounds Exhibition</div>
